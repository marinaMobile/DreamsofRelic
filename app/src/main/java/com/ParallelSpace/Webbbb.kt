...
import com.ParallelSpace.Apppppp.Companion.MAIN_ID
import com.ParallelSpace.databinding.ActivityWebbbbBinding
...
class Webbbb : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWebbbbBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWebbbbBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "dreamsofrelic.xyz/go.php?to=2&"
